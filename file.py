...
person = {'name': 'John', 'location': 'Salt Lake', 'age': 37, 'is_balding': False} #lsit
fruit = ('blueberry', 'strawberry', 'banana') #list
print(type(fruit)) #log statement
print(pizza_toppings[1]) #log statement
pizza_toppings.append('Mushrooms') #lists
print(person['name']) #log statement
person['name'] = 'George' #dictionaries
person['eye_color'] = 'blue' #dictionaries
...
pizza_toppings.pop() """ tuple 
pizza_toppings.pop(1) pop """
